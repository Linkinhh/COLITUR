...
export { default as PaginaNormativa} from "./pagina-normativa/PaginaNormativa";
export { default as PaginaColegiatura} from "./pagina-colegiatura/PaginaColegiatura";
...
export {default as ServicioMediosdePago} from "./servicio-mediosdepago/ServicioMediosdePago";